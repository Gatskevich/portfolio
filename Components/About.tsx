...
const About = () => {
  return (
    <div id="about" className="bg-[#121121] pb-[3rem] pt-[8rem]">
            ...
            <div>
                ...
                <div className="mb-[3rem] flex items-center md:space-x-10">
                    ...
                    <p className="text-[19px] text-slate-300 w-[80%]">
                        ...
                        Tempore facilis perspiciatis exercitationem quas obcaecati id facere et. 
                        Reiciendis quam ullam repellat aperiam, veniam eligendi doloremque quasi reprehenderit? Deserunt, expedita ut!
                    </p>
                </div>
