        ...
        <div className="w-[80%] grid-cols-1 mx-auto grid lg:grid-cols-2 gap-[3rem] h-[100%] items-center">
            <div>
                <h1 className="text-[35px] md:text-[50px] text-white font-bold">
                    Hi, I'M <span className="text-yellow-400">RODION!</span>
                </h1>
                <TextEffect />
                <p className="mt-[2rem] text-[20px] text-[#ffffff92]">
                    Hi, I'm a developer who loves working with React, React Native, Redux, and
                    TypeScript. I'm experienced in testing my code using tools like Jest and Cypress to make sure
                    everything works well. I'm excited to work together to create cool new tech solutions!
                </p>
